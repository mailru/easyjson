...
//go:generate gotemplate "github.com/mailru/easyjson/opt/optional" Time(time.Time)
//go:generate gotemplate "github.com/mailru/easyjson/opt/optional" Duration(time.Duration)
